...
public class Main {
	...
	public static void main(String[] args) {
		...
		PrimeFinderThread Thread1=new PrimeFinderThread(0, 10000000,numerosPrimos);
		PrimeFinderThread Thread2=new PrimeFinderThread(10000000, 20000000,numerosPrimos);
		PrimeFinderThread Thread3=new PrimeFinderThread(20000000, 30000000,numerosPrimos);
		Thread1.start();
		Thread2.start();
		Thread3.start();
